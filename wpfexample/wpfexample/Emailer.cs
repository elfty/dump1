...
namespace wpfexample
{
    ...
    internal class Emailer
    {
        ...
        private string _host = "email.mlp.com";
        ...
        public Emailer(string toEmail, string fromEmail, string fromName, string toName, string subject, string emailBody, bool isBodyHtml)
        {
